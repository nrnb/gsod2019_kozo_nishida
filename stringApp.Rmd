...
For example, you can try the **Degree Sorted Circle Layout** with

```{r}
layoutNetwork('degree-circle')
```

You can try the **Prefuse Force Directed Layout** with
...
As a default, Cytoscape looks for an attribute value of ‘ID’ in the network and a user-supplied Key in the dataset.
