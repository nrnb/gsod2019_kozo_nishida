...
<center>
![](https://cytoscape.github.io/cytoscape-tutorials/protocols/mapping-data/1599px-GalWithCharts.png)
</center>
...
```{r}
updateStyleMapping("default", mapVisualProperty('node shape', 'gal80Rsig', 'c', c(0, 0.05, 1.00), c('rectangle', 'rectangle', 'ellipse')))
```
