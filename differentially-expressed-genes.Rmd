...
![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/string-enrichment.png)
...
- We are going to filter the table to only show GO Process. At the top left of the STRING enrichment tab, click the filter icon ![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/FilterIcon.png). Select **GO Process** and check the **Remove redundant terms** check-box. Then click OK.
- Next, we will add a split donut chart to the nodes representing the top terms by clicking on ![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/ChartIcon.png).
- Explore custom setting via ![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/SettingsIcon.png) in the top right of the STRING enrichment tab.

![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/string-enrichment-chart.png)
...
- Query STRING protein with the list of symbols in [TCGA-Ovarian-MesenvsImmuno_DOWN.txt](https://cytoscape.github.io/cytoscape-tutorials/protocols/data/TCGA-Ovarian-MesenvsImmuno_DOWN.txt).
...
![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/string-de-down.png)
...
- `mapped.cols` displays a report of how many identifiers were mapped. Make note of this information as it impacts all down-stream analysis; If the mapping was unsuccessful, downstream analysis will be as well. You should see the mapped `Entrez Gene` column with
...
Now you should see the integrated the column names of the data(`df`).
