...
![](https://cytoscape.org/cytoscape-tutorials/protocols/differentially-expressed-genes/string-ovarian-styled.png)
...
- Add a style bypass for node **Border Width** (5) and node **Border Paint** (bright pink). You can create a style bypass by
