...
- [x] [Loading Networks](https://cytoscape.github.io/cytoscape-tutorials/protocols/loading-networks/#/) with R [link to the commits](https://github.com/nrnb/gsod2019_kozo_nishida/issues/15)
